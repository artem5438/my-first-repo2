...
from .models import Movie, Session, Ticket, Genre, Hall  # Добавьте Hall в импорты
...
class SessionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Session
        fields = ['session_id', 'movie', 'movie_id', 'hall', 'hall_id', 'session_datetime', 'end_datetime', 'available_seats', 'price']
